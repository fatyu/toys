...
<HTML>
	...
	<BODY>
		...
		<form id="person" action="<%=basePath%>admin/personCustomerManage!update"
			...
			<TABLE cellSpacing=0 cellPadding=2 width="95%" align=center border=0>
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerId"
							value='<s:property value="#pc.getPersonCustomerId()" />'
							readonly="readonly">
					</TD>
				</TR>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerName"
							value='<s:property value="#pc.getPersonCustomerName()" />'
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerPhoneNum"
							value='<s:property value="#pc.getPersonCustomerPhoneNum()" />'
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerCardNum"
							value='<s:property value="#pc.getPersonCustomerCardNum()" />'
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerPostCode"
							value='<s:property value="#pc.getPersonCustomerPostCode()" />'
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerAddress"
							value='<s:property value="#pc.getPersonCustomerAddress()" />'
							class="required">
					</TD>
				</TR>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerHobby"
							value='<s:property value="#pc.getPersonCustomerHobby()" />'
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerEmail"
							value='<s:property value="#pc.getPersonCustomerEmail()" />'
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerAge"
							value='<s:property value="#pc.getPersonCustomerAge()" />'
							class="required max-value-80 min-value-18  ">
					</TD>
				</TR>
				<TR>
					<TD align=left width=100>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerJobTitle"
							value='<s:property value="#pc.getPersonCustomerJobTitle()" />'
							class="required max-length-20">
					</TD>
				</TR>
				<TR>
					<TD align=left width=100>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="personCustomer.personCustomerJobType"
							value='<s:property value="#pc.getPersonCustomerJobType()" />'
							class="required max-length-20">
					</TD>
				</TR>
				<TR>
