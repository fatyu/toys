...
<HTML>
	<HEAD>
		...
		<script>
	var valid = new Validation('nation');
</script>
	</HEAD>
	<BODY>
		...
		<form id="nation" action="<%=basePath%>admin/nationManage!update"
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="nationId"
							value='<s:property value="#nation.getNationId()" />'
							readonly="readonly">
					</TD>
				</TR>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="nationName"
							value='<s:property value="#nation.getNationName()" />'
							class="required max-length-10 ">
					</TD>
				</TR>
				<TR>
