...
<HTML>
	...
	<BODY>
		...
		<form id="type" action="<%=basePath%>admin/customerTypeManage!update" method="post" class='required-validate'>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="typeId"
							value='<s:property value="#ct.getTypeId()" />'
							readonly="readonly">
					</TD>
				</TR>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="typeName"
							value='<s:property value="#ct.getTypeName()" />' class="required max-length-10 ">
					</TD>
				</TR>
								<TR>
