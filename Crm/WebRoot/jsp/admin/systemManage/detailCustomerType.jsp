		...
		<TABLE cellSpacing=0 cellPadding=2 width="95%" align=center border=0>
			...
			<s:iterator value="#request.cts">
				<TR>
					...
					<TD style="COLOR: #880000">
						<a
							href='<%=basePath%>admin/customerTypeManage!preUpdate?typeId=<s:property value="typeId"  />'>修改类别信息</a>
					</TD>
				</TR>
			</s:iterator>
		</TABLE>
		<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
			...
			<TR height=22>
				<TD style="PADDING-LEFT: 20px; FONT-WEIGHT: bold; COLOR: #000000"
					align="center">
					<a
						href="<%=basePath%>jsp/admin/systemManage/addCustomerType.jsp"><img
