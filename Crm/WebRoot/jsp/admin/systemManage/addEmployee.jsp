...
<HTML>
	...
	<BODY>
		...
		<form id="empl" action="<%=basePath%>admin/employeeManage!add"
			...
			<TABLE cellSpacing=0 cellPadding=2 width="95%" align=center border=0>
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="employee.employeeName"
							class="required max-length-30 min-length-2">
					</TD>
				</TR>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="password" name="employee.employeePassword" class="required max-length-16 min-length-6" >
					</TD>
				</TR>
				...
				<TR>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="employee.employeeAddress" class="required max-length-30" >
					</TD>
				</TR>
				<TR>
					<TD align=left width=100>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="employee.employeeAge" class="required max-value-60 min-value-18" >
					</TD>
				</TR>
				<TR>
					<TD align=left width=100>
					...
					<TD style="COLOR: #880000">
						<input type="text" name="employee.employeeSalary" class="required  min-value-1">
					</TD>
				</TR>
				<TR>
					<TD align=left width=100>
					...
					<TD style="COLOR: #880000">
						<select name="employee.roleId">
							...
							<option  value="2" >客户服务人员</option>
							<option  value="3" >投诉处理人员</option>
							</select>
					</TD>
				</TR>
				<TR>
